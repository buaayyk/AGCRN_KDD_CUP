...
def prep_env():
    ...
    parser.add_argument('--start_col', type=int, default=3,
                        help='Index of the start column of the meaningful variables')
    ...
    parser.add_argument('--capacity', type=int, default=135, help="The capacity of a wind farm, "
    ...
    parser.add_argument('--rnn_units', type=int, default=64, help='The hidden dimension of our model')
    parser.add_argument('--embed_dim', type=int, default=10, help='The embedding dimension of out model')
    parser.add_argument('--groups', type=int, default=2, help='The number of model')
    parser.add_argument('--group_id', type=int, default=0, help='The id of model')
